%% Model of GluN1-1b/GluN2D Activation from Vance et al 2005 J Physiol

%% Pack the Q matrix
% GluN2D Rates in s^-1 or uM^-1*s^-1 from Vance et al (2012) J Physiol for GluN1-1b/GluN2D
bp = 0.28; % in uM^-1*s^-1
bm = 0.92;
k1p = 230;
k1m = 900;
